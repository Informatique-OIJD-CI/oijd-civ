...
export default function Footer() {
    ...
    return (
        <footer data-navbar-theme="dark" className="relative overflow-hidden">
            {/* Bandeau blanc plein largeur : logo, tagline, CTA */}
            <div className="w-full bg-white">
                <div className="container-x flex flex-col items-center text-center py-14 sm:py-16">
                    <img src={oijdLogo} alt="OIJD - Section Cote d'Ivoire" className="h-24 sm:h-28 w-auto" />

                    <p className="mt-2 text-sm italic text-black max-w-md">
            ...
            {/* Bandeau sombre : contact / navigation / copyright */}
            <div
            ...
            >
                ...
                <div className="container-x relative z-10 pt-14 sm:pt-16 pb-8">
